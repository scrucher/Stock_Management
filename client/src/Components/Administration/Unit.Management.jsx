...
const Unit = () => {
    ...
    return (
        <main className="min-h-screen bg-gray-100 p-6">
            <h2 className="text-4xl font-bold text-left mb-6 text-black">Unit Management</h2>
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-1 flex flex-col">
                    ...
                    <div className="form-control bg-white p-6 rounded-2xl shadow-md flex-grow">
                        <form onSubmit={HandleSubmit} className="flex flex-col h-full">
                            <h3 className="text-2xl font-bold mb-4 text-black">Create Unit</h3>
                ...
                <div className="md:col-span-2">
                    <div className="mb-6">
                        <h1 className="text-2xl font-semibold text-black">Units</h1>
                    </div>
                    <Table path={path} />
                </div>
            </div>
